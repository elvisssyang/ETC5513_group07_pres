...
- <b>Sample Selection Bias</b>: Our data source is not perfect. We only use the most recent data available to us , which is year 2020 data. The situation is the conclusion maybe not suitable for further analysis because of the COVID influences. In terms of NA values, we simply excluded them.The exclusion of the subset can influence the statistical significance of the tests, can be biased. 
